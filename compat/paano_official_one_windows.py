...
def main() -> int:
    ...
    # The released PaAno loader splits paths on '/'. Path.as_posix() is the
    # only Windows smoke-test compatibility change in this copy.
    train_data, train_labels, test_data, test_labels = load_and_split_data(data_file.as_posix())
