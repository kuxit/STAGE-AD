...
def _eval_files(repo: Path) -> tuple[dict[str, dict[str, list[str]]], dict[str, str]]:
...
def build_plan(
    ...
    files, manifest_hashes = _eval_files(repo)
...
def validate_plan(
    ...
    files, manifests = _eval_files(repo)
